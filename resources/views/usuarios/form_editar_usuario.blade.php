<form method="POST" action="{{ route('perfil.editar', $user_id) }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="inputSobrenome" value="{{ $usuario_sobrenome }}" name="sobrenome" >
        @error('sobrenome')
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="inputCpf" value="{{ $usuario_cpf }}" name="cpf">
        @error('cpf')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
